...
${OBJECTDIR}/logo_finder.o: logo_finder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/logo_finder.o logo_finder.cpp

${OBJECTDIR}/logo_finder_factory.o: logo_finder_factory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/logo_finder_factory.o logo_finder_factory.cpp
